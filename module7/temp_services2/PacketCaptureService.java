...
public class PacketCaptureService {
    ...
    public List<String> getAvailableInterfaces() {
        ...
        try {
            ...
            logger.severe("Error getting network interfaces: " + e.getMessage());
        }
        return interfaces;
    }
    ...
    public boolean startCapture(String interfaceName, String filter) {
        ...
        try {
            ...
            if (nif == null) {
                logger.severe("Network interface not found: " + actualInterfaceName);
                return false;
            }
            ...
            logger.severe("Error starting packet capture: " + e.getMessage());
            stopCapture();
            return false;
        }
    }
    ...
    public void stopCapture() {
        ...
        try {
            ...
            logger.severe("Error stopping packet capture: " + e.getMessage());
        }
    ...
    private void analyzeProtocolSpecifics(CapturedPacket capturedPacket, Packet packet) {
        try {
            ...
            logger.debug("Error analyzing protocol specifics", e);
        }
    }
    ...
    private void analyzeHTTP(CapturedPacket capturedPacket, Packet packet) {
        try {
            ...
            logger.debug("Error analyzing HTTP packet", e);
        }
    }
    ...
    private void analyzeDNS(CapturedPacket capturedPacket, Packet packet) {
        try {
            ...
            logger.debug("Error analyzing DNS packet", e);
        }
    }
    ...
    private void analyzeARP(CapturedPacket capturedPacket, Packet packet) {
        try {
            ...
            logger.debug("Error analyzing ARP packet", e);
        }
    }
    ...
    public void exportToPcap(String filename) throws Exception {
        ...
        logger.info("Exporting {} packets to PCAP file: {}", capturedPackets.size(), filename);
    }
} 